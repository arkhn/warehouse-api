...
class TestResource:
    ...
    def test_init_without_id_nor_resource(self, mock_get_store):
        ...
        with pytest.raises(OperationOutcome, match='An id or a resource must \
be provided'):
            r = Resource()
    ...
    def test_create(self, mock_uuid, mock_get_store):
        ...
        mock_get_store.return_value.create.return_value = \
            create_ret_data
        r = Resource(resource=resource_data)
...
an ID'):
    ...
    def test_update_without_id(self, mock_get_store):
        ...
        mock_get_store.return_value.update.return_value = \
            update_ret_data
        r = Resource(resource=resource_data)
    ...
    def test_update_id_dont_match(self, mock_get_store):
        ...
        with pytest.raises(OperationOutcome, match='Resource id and update \
...
update a resource'):
    ...
    def test_patch(self, mock_get_store):
        ...
        mock_get_store.return_value.patch.return_value = \
            patch_ret_data
        r = Resource(id=test_id['id'])
